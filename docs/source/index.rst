...
In this documentation, you will find detailed explanations of the system's architecture, including the ESP32 physical sensor layer, the Raspberry Pi 5 edge anomaly detector, and the Streamlit-based Security Operations Center (SOC) hosted in the cloud. It covers the core functionalities of our detection engine, which utilizes Machine Learning (Isolation Forest) and Process Mining (Markov models) to identify Data Injection, Flooding (DoS), Replay, and State Tampering attacks.
